...
exports.configureLogic = configureLogic;
...
function createLogic() {
  ...
  if (NODE_ENV !== 'production' && typeof processOptions.dispatchMultiple !== 'undefined' && warnTimeout !== 0) {
    ...
    console.error("warning: in logic for type(s): ".concat((0, _utils.stringifyType)(type), " - dispatchMultiple is always true in next version. For non-ending logic, set warnTimeout to 0"));
  }
  ...
  switch (processLength) {
    ...
    case 2:
      ...
      if (NODE_ENV !== 'production' && !processOptions.dispatchMultiple && warnTimeout !== 0) {
        // eslint-disable-next-line no-console
        console.error("warning: in logic for type(s): ".concat((0, _utils.stringifyType)(type), " - single-dispatch mode is deprecated, call done when finished dispatching. For non-ending logic, set warnTimeout: 0"));
