...
import { getRelativeSize, getPercentageSizeWidth } from '../../../utils/utils.js'
...
export const StyledButton = styled.TouchableOpacity`
  background-color: ${g => g.theme.color.button.primaryBlue};
  padding: ${getRelativeSize(15)} ${getRelativeSize(10)};
  border-radius: ${g => g.theme.radius.medium};
  flex-direction: row;
  align-items: center;
  justify-content: center;
  border-color: ${g => g.theme.color.button.primaryBlue};
  border-width: 1px;
